...
class FirewallController extends Controller
{
    public function natRules(Request $request)
    {
        ...
        return view('crm::mikrotik.nat-rules', compact('servers', 'selectedServer', 'natRules'));
    }
    ...
    public function addressList(Request $request)
    {
        ...
        return view('crm::mikrotik.address-list', compact('servers', 'selectedServer', 'addressList', 'listName'));
    }
}
