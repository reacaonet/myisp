...
class HotspotCouponController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('crm::hotspot-coupons.index', compact('coupons', 'stats'));
    }

    public function create()
    {
        $servers = Server::orderBy('name')->get();
        return view('crm::hotspot-coupons.create', compact('servers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('crm.hotspot-coupons.index')
    ...
    public function show($id)
    {
        ...
        return view('crm::hotspot-coupons.show', compact('coupon'));
    }
    ...
    public function edit($id)
    {
        ...
        $servers = Server::orderBy('name')->get();
        return view('crm::hotspot-coupons.edit', compact('coupon', 'servers'));
    }
    ...
    public function generateBatch(Request $request)
    {
        ...
        return view('crm::hotspot-coupons.batch', compact('coupons'));
    }
}
