...
class MikrotikController extends Controller
{
    public function pppoeActive(Request $request)
    {
        ...
        return view('crm::mikrotik.pppoe-active', compact('servers', 'selectedServer', 'activeSessions'));
    }
    ...
    public function hotspotActive(Request $request)
    {
        ...
        return view('crm::mikrotik.hotspot-active', compact('servers', 'selectedServer', 'activeSessions'));
    }
