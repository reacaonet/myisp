...
class ProvisionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('crm::provisioning.index', compact('records', 'servers'));
    }
    ...
    public function create()
    {
        ...
        return view('crm::provisioning.create', compact('servers', 'clients'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('crm.provisioning.index')
