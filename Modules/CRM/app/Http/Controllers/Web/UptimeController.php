...
class UptimeController extends Controller
{
    public function index()
    {
        ...
        return view('crm::uptime.index', compact('monitors', 'stats'));
    }

    public function create()
    {
        $servers = Server::orderBy('name')->get();
        return view('crm::uptime.create', compact('servers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('crm.uptime.index')
    ...
    public function show($id)
    {
        ...
        return view('crm::uptime.show', compact('monitor', 'checks', 'uptimePercent'));
    }
    ...
    public function edit($id)
    {
        ...
        $servers = Server::orderBy('name')->get();
        return view('crm::uptime.edit', compact('monitor', 'servers'));
    }
