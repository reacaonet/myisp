...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('crm.contracts.edit', $contract) }}" class="px-4 py-2 text-sm font-medium text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50">Editar</a>
            </div>
        </div>
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <a href="{{ route('crm.clients.show', $contract->client) }}" class="text-sm text-blue-600 hover:underline mt-2 inline-block">Ver cliente</a>
            </div>
    ...
    <div class="mt-4 flex justify-end">
        <form method="POST" action="{{ route('crm.contracts.destroy', $contract) }}" onsubmit="return confirm('Tem certeza que deseja remover este contrato?')">
            @csrf @method('DELETE')
            <button type="submit" class="px-4 py-2 text-sm font-medium text-red-600 border border-red-200 rounded-lg hover:bg-red-50">Remover Contrato</button>
        </form>
    </div>
</div>
@endsection
