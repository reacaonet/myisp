...
<div class="mt-6 flex justify-end gap-3">
    <a href="{{ route('crm.hotspot-coupons.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50">Cancelar</a>
