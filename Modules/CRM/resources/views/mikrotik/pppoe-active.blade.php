...
<div class="max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <form method="GET" action="{{ route('crm.mikrotik.pppoe-active') }}">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('crm.mikrotik.pppoe-active', ['server_id' => $selectedServer->id]) }}"
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <form method="POST" action="{{ route('crm.mikrotik.kick-pppoe', $selectedServer->id) }}" class="inline"
