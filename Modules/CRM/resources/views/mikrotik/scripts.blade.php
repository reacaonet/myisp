...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('crm.mikrotik-servers.index') }}" class="text-sm text-blue-600 hover:underline">Voltar</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form method="POST" action="{{ route('crm.mikrotik.scripts.generate') }}" class="p-6 space-y-6">
            @csrf
