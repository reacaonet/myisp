...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form method="POST" action="{{ route('crm.provisioning.store') }}" class="p-6 space-y-4">
            @csrf
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                <a href="{{ route('crm.provisioning.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700">Cancelar</a>
