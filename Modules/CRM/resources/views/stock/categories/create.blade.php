...
@section('content')
<div class="max-w-xl">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Nova Categoria</h2>

    <form method="POST" action="{{ route('crm.stock-categories.store') }}" class="bg-white rounded-lg shadow p-6 space-y-4">
        @csrf
        <div>
