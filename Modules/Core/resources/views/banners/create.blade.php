            ...
            <div class="border-t border-gray-100 pt-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <input type="color" value="{{ old('title_color', '#ffffff') }}" data-color-target="input[name='title_color']"
                                   class="w-11 h-9 rounded-lg border border-gray-300 p-1 bg-white cursor-pointer">
                            <input type="text" name="title_color" value="{{ old('title_color') }}" placeholder="#ffffff"
                    ...
                    <div>
                        ...
                        <input type="number" name="title_font_size" value="{{ old('title_font_size') }}" min="16" max="120" placeholder="Padrao"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <input type="color" value="{{ old('subtitle_color', '#e2e8f0') }}" data-color-target="input[name='subtitle_color']"
                                   class="w-11 h-9 rounded-lg border border-gray-300 p-1 bg-white cursor-pointer">
                            <input type="text" name="subtitle_color" value="{{ old('subtitle_color') }}" placeholder="#e2e8f0"
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm font-mono" data-color-mirror>
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tamanho do Subtitulo (px)</label>
                        <input type="number" name="subtitle_font_size" value="{{ old('subtitle_font_size') }}" min="12" max="64" placeholder="Padrao"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                    </div>
                </div>
