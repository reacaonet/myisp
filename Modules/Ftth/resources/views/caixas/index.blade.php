...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('ftth.caixas.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-sm">
                    <div class="flex items-center gap-1">
                        <a href="{{ route('ftth.caixas.show', $caixa) }}" class="p-1.5 text-gray-400 hover:text-blue-600 rounded" title="Ver">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                        </a>
                        <a href="{{ route('ftth.caixas.edit', $caixa) }}" class="p-1.5 text-gray-400 hover:text-yellow-600 rounded" title="Editar">
