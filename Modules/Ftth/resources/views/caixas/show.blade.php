...
<div class="max-w-5xl mx-auto">
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
            <a href="{{ route('ftth.caixas.index') }}" class="inline-flex items-center gap-1 px-3 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('ftth.caixas.edit', $caixa) }}" class="inline-flex items-center gap-1 px-4 py-2 text-white rounded-lg text-sm font-medium" style="background-color:#2563eb;" onmouseover="this.style.backgroundColor='#1d4ed8'" onmouseout="this.style.backgroundColor='#2563eb'">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                Editar
            </a>
            <form method="POST" action="{{ route('ftth.caixas.destroy', $caixa) }}" onsubmit="return confirm('Excluir esta Caixa de Emenda? Esta acao nao pode ser desfeita.');">
                @csrf @method('DELETE')
