            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-sm">
                    <div class="flex items-center gap-1">
                        ...
                        <a href="{{ route('ftth.ctos.edit', $cto) }}" class="p-1.5 text-blue-500 hover:text-blue-700 rounded" title="Editar">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        </a>
                        <form method="POST" action="{{ route('ftth.ctos.destroy', $cto) }}" onsubmit="return confirm('Excluir esta CTO? Esta acao nao pode ser desfeita.')" class="inline">
                            @csrf @method('DELETE')
