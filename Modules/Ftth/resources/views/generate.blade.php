...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form method="POST" action="{{ route('ftth.generate.run') }}" class="p-6 space-y-4">
            @csrf
...
-27.5957000, -48.5484000">{{ old('coordinates') }}</textarea>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                <a href="{{ route('ftth.dashboard') }}" class="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-500">Cancelar</a>
