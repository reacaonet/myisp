...
class EquipmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('infra::equipment.index', compact('equipment'));
    }

    public function create()
    {
        $manufacturers = Manufacturer::orderBy('name')->get();
        return view('infra::equipment.create', compact('manufacturers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('infra.equipment.index')
    ...
    public function show($id)
    {
        ...
        return view('infra::equipment.show', compact('equipment'));
    }
    ...
    public function edit($id)
    {
        ...
        $manufacturers = Manufacturer::orderBy('name')->get();
        return view('infra::equipment.edit', compact('equipment', 'manufacturers'));
    }
