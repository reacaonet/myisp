...
<head>
    ...
    <title>Portal de Infraestrutura - MyISP</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-icon { width: 56px; height: 56px; border-radius: 16px; background: linear-gradient(135deg, #3b82f6, #2563eb);
        ...
        .input-wrap input:focus { border-color: #3b82f6; background: #fff; box-shadow: 0 0 0 3px rgba(59,130,246,0.1); }
        .input-wrap input:focus ~ svg { color: #3b82f6; }
...
<body>
    <div class="login-card">
        <div class="card-inner">
            ...
            <form method="POST" action="{{ route('infra.login') }}">
                @csrf
