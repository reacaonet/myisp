            ...
            <div class="border-t border-gray-200 pt-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="fiber_fusions" value="{{ old('fiber_fusions', $caixa->fiber_fusions) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="text" name="splitter_config" value="{{ old('splitter_config', $caixa->splitter_config) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="olt_port" value="{{ old('olt_port', $caixa->olt_port) }}"
                ...
                <div class="mt-4">
                    ...
                    <textarea name="project_notes" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm" placeholder="Dados de fusao, splitters, cabos, etc.">{{ old('project_notes', $caixa->project_notes) }}</textarea>
                </div>
            </div>
