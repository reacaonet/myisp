    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            ...
            <div class="text-center py-8">
                ...
                <a href="{{ route('infra.ftth.generate.city') }}" class="mt-3 inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700">
                    Gerar Rede Primeiro
                </a>
            </div>
            @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <a href="{{ route('infra.ftth.export.kml.download', $city) }}"
                   class="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg hover:border-green-400 hover:bg-green-50 transition-all group">
                    <div>
                        ...
                        <p class="text-xs text-gray-500">
                            @php
                                $ctoCount = \Modules\PortalInfra\Models\Cto::where('city', $city)->count();
                                $caixaCount = \Modules\PortalInfra\Models\CaixaEmenda::where('city', $city)->count();
                            @endphp
