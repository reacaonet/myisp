...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('infra.ftth.generate') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200">Gerar Nova Rede</a>
        </div>
        <div class="p-6">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <a href="{{ route('infra.ftth.caixas.show', $caixa) }}" class="flex items-center justify-between p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200">
                        <div>
