    ...
    <div class="h-screen overflow-hidden">
        <aside id="appSidebar" class="bg-gray-900 text-white flex flex-col overflow-hidden">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('infra.mikrotik.scripts') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('infra.mikrotik.scripts*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                ...
                <a href="{{ route('infra.ftth.editor.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('infra.ftth.editor*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
