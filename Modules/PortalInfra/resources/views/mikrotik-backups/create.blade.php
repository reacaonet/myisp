...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('infra.mikrotik-backups.index') }}" class="text-sm text-blue-600 hover:underline">Voltar</a>
    </div>
    ...
    <form method="POST" action="{{ route('infra.mikrotik-backups.store') }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        @csrf
        <div class="space-y-4">
            <div>
        ...
        <div class="mt-6 flex justify-end gap-3">
            <a href="{{ route('infra.mikrotik-backups.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50">Cancelar</a>
