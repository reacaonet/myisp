            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-sm">
                    <div class="flex items-center gap-1">
                        ...
                        <form method="POST" action="{{ route('infra.ftth.projects.destroy', $project) }}" onsubmit="return confirm('Excluir este projeto? TODAS as CTOs e Caixas de Emenda do projeto tambem serao excluidas. Esta acao nao pode ser desfeita.')" class="inline">
                            @csrf @method('DELETE')
