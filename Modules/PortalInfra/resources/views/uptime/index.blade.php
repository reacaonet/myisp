...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-3">
            <form method="POST" action="{{ route('infra.uptime.check-all') }}" class="inline">
                @csrf
            ...
            <a href="{{ route('infra.uptime.create') }}" title="Novo Monitor" class="p-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg></a>
        </div>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 font-medium"><a href="{{ route('infra.uptime.show', $monitor) }}" class="text-blue-600 hover:underline">{{ $monitor->name }}</a></td>
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center gap-0.5">
                            <form method="POST" action="{{ route('infra.uptime.check', $monitor) }}" class="inline">
                                @csrf
                            ...
                            <a href="{{ route('infra.uptime.edit', $monitor) }}" title="Editar" class="p-1.5 rounded hover:bg-blue-50 text-blue-600"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></a>
                        </div>
                    </td>
                </tr>
                @empty
